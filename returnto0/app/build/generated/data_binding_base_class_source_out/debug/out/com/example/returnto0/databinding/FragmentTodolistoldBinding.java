...
public final class FragmentTodolistoldBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentTodolistoldBinding(@NonNull FrameLayout rootView, @NonNull CardView cardView1,
  ...
  @NonNull
  public static FragmentTodolistoldBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentTodolistoldBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_todolistold, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentTodolistoldBinding bind(@NonNull View rootView) {
