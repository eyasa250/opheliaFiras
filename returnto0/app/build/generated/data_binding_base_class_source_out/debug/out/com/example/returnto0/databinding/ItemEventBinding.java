...
public final class ItemEventBinding implements ViewBinding {
  ...
  private ItemEventBinding(@NonNull CardView rootView, @NonNull TextView date,
      @NonNull TextView day, @NonNull TextView description, @NonNull TextView month,
  ...
  public static ItemEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEventBinding((CardView) rootView, date, day, description, month, options,
          status, time, title);
    }
