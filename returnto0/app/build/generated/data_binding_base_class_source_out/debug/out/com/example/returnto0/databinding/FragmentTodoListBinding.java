...
public final class FragmentTodoListBinding implements ViewBinding {
  ...
  private FragmentTodoListBinding(@NonNull FrameLayout rootView, @NonNull CardView cardView1,
  ...
  public static FragmentTodoListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTodoListBinding((FrameLayout) rootView, cardView1, cardView2, cardView3,
